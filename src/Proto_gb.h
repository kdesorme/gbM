...
extern void Gb_v6_print(const Gb_v6* u);
...
extern void Gb_th_x_dep ( const Gb_th* th, const Gb_dep* dep, Gb_dep* deps );
...
extern void Gb_th_print_euler(Gb_th* th, Gb_v6* s);
